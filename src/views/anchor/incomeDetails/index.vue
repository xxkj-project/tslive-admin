        ...
        <el-table :data="tableList" tooltip-effect="dark" style="width: 100%">
          ...
          <el-table-column label="操作" min-width="160">
            <template slot-scope="scope">
              <el-button type="primary" size="mini" icon="el-icon-s-data" @click="onGiftDetails(scope.row)"
                >礼物流水详情</el-button
              >
            </template>
          </el-table-column>
...
import giftDetails from '@/views/anchor/components/income/handleGiftDetails'
import { getIncomeList } from '@/api/anchor'
