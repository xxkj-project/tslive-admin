<template>
  <div class="userList">
    <searchForm :formOptions="formOptions" @onSearch="handleSearch">
      <el-button slot="button" size="mini" type="primary" icon="el-icon-upload" class="btn-search" @click="onAddVideo"
        >上传视频</el-button
      >
    </searchForm>
          ...
          <el-table-column label="操作" fixed="right" min-width="340">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                :icon="scope.row.shelves ? 'el-icon-sold-out' : 'el-icon-sell'"
...
import { findVideoList, auditShortVideo, updownVideo } from '@/api/shortVideo'
export default {
  name: '',
  data() {
    return {
