 ...
 * @LastEditTime: 2020-09-29 14:54:44
 * @Desc: 实名认证 - 身份认证list
-->
<template>
  <div class="identity-auth">
    <el-table :data="list" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelChange">
      ...
      <el-table-column :key="Math.random()" prop="region" label="地区" min-width="120"></el-table-column>
      <el-table-column prop="mobile" label="证件类型" min-width="80" :formatter="certificateFormatter">
      </el-table-column>
      <el-table-column :key="Math.random()" prop="name" label="姓名" min-width="120"></el-table-column>
      <el-table-column :key="Math.random()" prop="certificateNo" label="证件号" min-width="180"></el-table-column>
