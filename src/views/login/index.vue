  ...
  watch: {
    $route: {
      handler: function(route) {
        ...
        // console.log('-watch-login-route-query-', query)
        if (query) {
      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          const data = {
            ...
            pwd: md5.hex(this.loginForm.password)
          }
          login(data)
            .then(res => {
              console.log(res)
              ...
              this.$store
                ...
                .then(() => {
                  console.log('-open-open-path-', this.redirect, '-query-', this.otherQuery)
